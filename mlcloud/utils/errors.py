...
class MLCloudError(Exception):
    """Base exception for mlcloud with user-friendly error messages."""
...
class BlueprintError(MLCloudError):
    """Blueprint-related errors."""

    pass


class ValidationError(MLCloudError):
    """Validation errors."""

    pass


class ProviderError(MLCloudError):
    """Provider-specific errors."""

    pass


class ConfigurationError(MLCloudError):
    """Configuration errors."""

    pass


class DependencyError(MLCloudError):

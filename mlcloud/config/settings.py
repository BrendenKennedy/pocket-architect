...
class Settings(BaseSettings):
    ...
    # Base directories
    home_dir: Path = Field(default_factory=lambda: Path.home() / ".mlcloud")
    state_dir: Path = Field(default_factory=lambda: Path.home() / ".mlcloud")
    models_dir: Path = Field(default_factory=lambda: Path.home() / ".mlcloud" / "models")
    ...
    # CoreWeave settings
    coreweave_namespace: str = Field(default="mlcloud", description="Kubernetes namespace")

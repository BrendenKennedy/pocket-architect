...
def train(
    ...
    Examples:
        mlcloud train config.yaml --provider aws
        mlcloud train training-config.yml --provider coreweave
    """
    ...
    try:
        ...
        try:
            ...
            console.print(f"[green]Monitor logs:[/green] mlcloud train status --provider {provider_enum.value}")
            ...
            console.print(f"[yellow]Connect to instance manually:[/yellow] mlcloud shell --provider {provider_enum.value}")

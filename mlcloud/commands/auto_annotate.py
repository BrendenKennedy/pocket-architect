...
from mlcloud.models.inference import InferenceEngine, convert_to_cvat_format
from mlcloud.models.registry import ModelRegistry
from mlcloud.utils.rich_ui import display_info, display_success, display_error
...
def main(
    ...
    Examples:
        ...
        mlcloud auto-annotate video.mp4 --model yolo11-seg --provider aws
    """

...
# Import commands
from pocket_architect.commands import auto_annotate, cvat, train
from pocket_architect.commands import shell, destroy, list as list_cmd, status, blueprint

app = typer.Typer(
    name="pocket-architect",
...
def version_callback(value: bool) -> None:
    ...
    if value:
        console.print(f"[bold]pocket-architect[/bold] version [cyan]{__version__}[/cyan]")
        raise typer.Exit()
...
def main(
    ...
    """pocket-architect - On-demand GPU computer-vision workstation CLI."""

...
from pocket_architect.core.blueprint import Blueprint
...
def create(
    ...
    Examples:
        pocket-architect blueprint create aws
        pocket-architect blueprint create aws --type training --output my-training.yaml
        pocket-architect blueprint create local --format tfvars
    """
    try:
        # Validate provider
        try:
        ...
        console.print(f"[dim]Use it with: pocket-architect cvat up --blueprint {output}[/dim]")
...
def validate(
    ...
    Examples:
        pocket-architect blueprint validate my-config.yaml
        pocket-architect blueprint validate config.tfvars
    """
    try:
        ...
        console.print("3. Use `pocket-architect blueprint show` to view contents")
        console.print("4. Recreate with: `pocket-architect blueprint create`\n")
        raise typer.Exit(1)
...
def show(
    ...
    Examples:
        pocket-architect blueprint show my-config.yaml
    """
    try:
        blueprint = Blueprint.from_file(blueprint_file)
        ...
        console.print("3. Validate with: `pocket-architect blueprint validate {blueprint_file}`\n")
        raise typer.Exit(1)
